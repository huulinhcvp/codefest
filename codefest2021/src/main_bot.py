...
class GameMap:
    ...
    def __init__(self, data):
        ...
        self._my_bot = self.map_info["players"][0]
        self._opp_bot = self.map_info["players"][1]
        self._my_pos = (
        ...
        self._power = self.my_bot['power']
        self._pill_avail = self.my_bot["pill"]
...
async def send_infor():
    infor = {"game_id": GAME_ID, "player_id": "player1-xxx"}
...
async def map_state(data):
    ...
    if data['tag'] == 'update-data':
        ...
        my_pos = (
            map_info["players"][0]["currentPosition"]["row"],
            map_info["players"][0]["currentPosition"]["col"]
        )
